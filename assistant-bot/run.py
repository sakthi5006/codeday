...
k.learn("config.aiml")
k.learn("dialog.aiml")
k.learn("inappropriate.aiml")
k.learn("insults.aiml")
k.learn("profanity.aiml")
k.learn("reductions_update.aiml")
k.learn("reductions1.aiml")
k.learn("reductions2.aiml")
k.learn("roman.aiml")
k.learn("train.aiml")
k.learn("udc.aiml")
k.learn("utilities.aiml")
k.learn("z_update.aiml")
